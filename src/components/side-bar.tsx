...
export default function SideBar() {
  ...
  const SidebarContent = () => (
    <div
      className={`fixed inset-y-0 left-0 w-64 bg-white shadow-md pl-4 pr-4 pt-12 flex flex-col transition-transform duration-300 ease-in-out z-40 md:static md:translate-x-0 md:pt-2 md:h-screen ${
  ...
  return (
    <>
      ...
      {/* Sidebar: Render conditionally on mobile, always on desktop */}
      {isMobileMenuOpen ? <SidebarContent /> : <div className="md:block"><SidebarContent /></div>}
    </>
  );
}